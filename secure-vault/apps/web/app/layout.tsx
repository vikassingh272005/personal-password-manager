    ...
    <html lang="en" className={inter.variable}>
      <body className="dark">
        ...
        <div className="flex min-h-screen bg-background text-foreground">
          <Sidebar />
          <main className="relative flex-1 overflow-y-auto pb-28 md:pb-10">
            <div
              aria-hidden
        ...
        {/* Marketing pattern for phones; the Sidebar covers md+ (hidden there
            to keep the marketing chrome off auth and admin screens). */}
        <BottomNav />
      </body>
    </html>
  );
